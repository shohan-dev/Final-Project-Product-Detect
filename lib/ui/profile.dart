      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            prefixIcon: const Icon(Icons.person, color: AppColors.deep_blue,),
            hintText: 'Your name',
            labelText: 'Name',
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            prefixIcon: const Icon(Icons.phone, color: AppColors.deep_blue,),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            prefixIcon: const Icon(Icons.calendar_today, color: AppColors.deep_blue,),
            hintText: 'Your age',
            labelText: 'Age',
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(15.0),
